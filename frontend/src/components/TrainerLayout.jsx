    ...
    return (
        <div className="flex h-screen bg-gray-50 dark:bg-darkBg transition-colors font-sans overflow-hidden">
            ...
            `}>
                <div className="hidden md:flex p-6 border-b border-slate-800 justify-between items-center">
                    <div>
                        ...
                        <p className="text-[10px] text-slate-400 mt-1 uppercase tracking-widest font-bold">Trainer Portal</p>
                    </div>
                    <button
                        onClick={toggleTheme}
                ...
                <div className="px-6 py-4 flex items-center gap-3 border-b border-slate-800/50 bg-slate-800/20">
                    <div className="w-8 h-8 rounded-full bg-brown/20 border border-brown/50 text-brown flex items-center justify-center font-black shadow-sm text-xs">
                        {userName ? userName[0] : 'T'}
                    </div>
                    <div>
                        <p className="text-sm font-bold text-white truncate max-w-[130px]">{userName || 'Trainer'}</p>
                    </div>
                </div>
            ...
            <main className="flex-1 overflow-y-auto pt-16 md:pt-0 bg-gray-50 dark:bg-darkBg transition-colors relative">
                ...
                <div className="absolute top-0 right-0 w-96 h-96 bg-brown/5 dark:bg-brown/10 rounded-full mix-blend-multiply filter blur-3xl opacity-50 pointer-events-none"></div>
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-cream/5 dark:bg-cream/5 rounded-full mix-blend-multiply filter blur-3xl opacity-50 pointer-events-none"></div>
