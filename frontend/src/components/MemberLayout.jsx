            ...
            `}>
                <div className="hidden md:flex p-6 border-b border-slate-800 justify-between items-center">
                    <div>
                        ...
                        <p className="text-[10px] text-slate-400 mt-1 uppercase tracking-widest font-bold">Member Portal</p>
                    </div>
                    <button
                        onClick={toggleTheme}
                ...
                <div className="px-6 py-4 flex items-center gap-3 border-b border-slate-800/50 bg-slate-800/20">
                    <div className="w-8 h-8 rounded-full bg-olive/20 border border-olive/50 text-olive flex items-center justify-center font-black shadow-sm text-xs">
                        {userName ? userName[0] : 'M'}
                    </div>
                    <div>
                        <p className="text-sm font-bold text-white truncate max-w-[130px]">{userName || 'Member'}</p>
                    </div>
                </div>
